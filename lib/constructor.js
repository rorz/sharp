 ...
 * @param {string} [options.text.text] - text string to render.
 * @param {string} [options.text.font="sans"] - font name to render with.
 * @param {string} [options.text.fontfile] - absolute filesystem path to a font file that can be used by `font`.
 * @param {number} [options.text.width=0] - integral number of pixels wide. When omitted, can be used with `dpi` to output single-line text images of arbitrary width.
