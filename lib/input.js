  ...
  if (is.object(inputOptions)) {
    ...
    if (is.defined(inputOptions.text)) {
      if (is.object(inputOptions.text) && is.string(inputOptions.text.text)) {
        ...
        inputDescriptor.textHeight = is.defined(inputOptions.text.height)
        ? inputOptions.text.height
        : 0;
        inputDescriptor.textAlign = 0
        if (inputOptions.text.alignment === "right") {
          inputDescriptor.textAlign = 2;
        } else if (
          inputOptions.text.alignment === "centre" ||
          inputOptions.text.alignment === "center"
        ) {
          inputDescriptor.textAlign = 1;
        }
        inputDescriptor.textVerticalAlign = 0;
        if (inputOptions.text.verticalAlignment === "bottom") {
          inputDescriptor.textVerticalAlign = 2;
        } else if (
          inputOptions.text.verticalAlignment === "centre" ||
          inputOptions.text.verticalAlignment === "center"
        ) {
          inputDescriptor.textVerticalAlign = 1;
        }
        const textColor = color(inputOptions.text.color);
        ...
        const background = color(inputOptions.text.backgroundColor);
        ...
        inputDescriptor.textFont = inputOptions.text.fontName;
        inputDescriptor.textFontfile = inputOptions.text.fontFile;
        inputDescriptor.textJustify = inputOptions.text.shouldJustify;
        inputDescriptor.textDpi = inputOptions.text.dpi;
        inputDescriptor.textAutofitDpi = 0;
        inputDescriptor.textLineSpacing = inputOptions.text.lineSpacing;
