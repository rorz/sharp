  ...
  if (is.object(inputOptions)) {
    ...
    if (is.defined(inputOptions.text)) {
      if (is.object(inputOptions.text) && is.string(inputOptions.text.text)) {
        ...
        const textColor = color(inputOptions.text.foreground);
        inputDescriptor.textForeground = [
          textColor.red(),
          textColor.green(),
          textColor.blue(),
          Math.round(textColor.alpha() * 255)
        ];
        const background = color(inputOptions.text.background);
        ...
        inputDescriptor.textLineSpacing = inputOptions.text.spacing;
